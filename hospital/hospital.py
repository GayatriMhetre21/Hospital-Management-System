...
def login():
    ...
    if usernameVar.get()=="python" and passwordVar.get()=="1":
        try:
            frame1.destroy()
        except:
            pass
    ...
    if counterlogin==1:
        ...
        framehospitalname=Label(framemenuroot,text="                                  FLOWERS HOSPITAL",bg="lightgreen",fg="red",width="35",font=("calibri",27,"bold"))
